...
import BodyWrapper from "@/components/custom/BodyWrapper";
        ...
        <div className="bg-linear-to-r from-purple-50 to-blue-50 p-8 rounded-lg border border-purple-200 animate-fade-in">
          ...
          <div className="h-12 overflow-hidden">
            <div className="animate-flip-vertical flex flex-col">
              <span className="text-3xl font-bold text-purple-600 h-12 flex items-center">
                work
              </span>
              <span className="text-3xl font-bold text-blue-600 h-12 flex items-center">
                lifestyle
              </span>
              <span className="text-3xl font-bold text-purple-600 h-12 flex items-center">
                everything
